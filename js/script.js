...
function func() {
  ...
  if (nav.style.transform == "translateX(0rem)") {
    document.getElementById("nav").style.transform = "translateX(15rem)";
    document.getElementById("icon").innerHTML = "☰";
    document.getElementById("icon").style.paddingRight = "1rem";

  } else {
    document.getElementById("nav").style.transform = "translateX(0rem)";
    document.getElementById("icon").innerHTML = "&times;";
    document.getElementById("icon").style.paddingRight = "1.5rem";
  }
}
var slideIndex = 1;
